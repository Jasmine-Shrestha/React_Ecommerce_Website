...
function App() {
  return (
    ...
    <Route path='/womens' element={<ShopCategory banner={womenswear} category="women"/>}/>
    <Route path='/mens' element={<ShopCategory banner={mensbanner} category="men"/>}/>
    <Route path='/kids' element={<ShopCategory banner={kidswear} category="kid"/>}/>
    <Route path='/ornament' element={<ShopCategory banner={nepaliornamaent} category="Ornaments"/>}/>
